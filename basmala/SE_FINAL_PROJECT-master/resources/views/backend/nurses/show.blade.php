...
<div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Nurse, {{ $nurse->name }}</h2>
            </div>
        ...
        <div class="table w-full mt-8 bg-white rounded">
            ...
            <div class="w-full max-w-xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <img class="w-20 h-20 sm:w-32 sm:h-32 rounded" src="{{ asset('images/profile/' .$nurse->user->profile_picture) }}" alt="avatar">
                    </div>
                </div>
